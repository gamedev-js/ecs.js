...
export default class Entity {
  ...
  addTween(component, prop, option) {
    if (!this._vtweens) {
      this._vtweens = this._app.tweenEngine.newTimeLine({});
    }

    if (component === 'Entity') {
      let vtween = this._app.tweenEngine.newTask(this, prop, option);
      this._vtweens.add(vtween);
      return;
    }
    ...
    let vtween = this._app.tweenEngine.newTask(com, prop, option);
    this._vtweens.add(vtween);
  }
