...
export default class App {
  ...
  registerClass(name, cls) {
    ...
    if (schema) {
      let prototypeAccessors = Schema.createPrototypeAccessors(schema, this._types, this._classes);
  ...
  createObject(classname, data) {
    ...
    return Schema.instantiate(ctor, data || {}, this._types, this._classes);
  }
  ...
  _createComp(ctor, ent) {
    let comp = Schema.instantiate(ctor, {}, this._types, this._classes);
    comp._app = this;
