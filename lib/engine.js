...
export default class Engine {
  ...
  constructor(opts = {}) {
    ...
    this._activeLevel._engine = this;
  ...
  _createComp(ctor, ent) {
    ...
    // invoke onEnable
    if (comp._enabled && comp.onEnable && ent._ready && ent.enabledInHierarchy ) {
      comp.onEnable();
    }
  ...
  _destroyComp(comp) {
    ...
    // invoke onDisable
    if (comp._enabled && comp.onDisable && ent._ready && ent.enabledInHierarchy) {
      comp.onDisable();
    }
